/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 35e8cc4d99b67f2796a9d0554d98a3c8)
...
interface __BaseEnv_Env {
	...
	TAVILY_DAILY_CALL_LIMIT: "1000";
	RESEARCH_JOB_TTL_SECONDS: "86400";
	KEY_QUARANTINE_SECONDS: "600";
	MAX_RESEARCH_JOBS: "2000";
	MCP_ALLOWED_ORIGINS: "https://chatgpt.com,https://chat.openai.com";
	// Secrets / optional overrides (not in wrangler vars).
	TAVILY_API_KEY?: string;
	MCP_PATH_TOKEN?: string;
	TAVILY_HUMAN_ID?: string;
	DEFAULT_PARAMETERS?: string;
	TAVILY_COORDINATOR: DurableObjectNamespace<import("./src/worker").TavilyCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "TavilyCoordinator";
	}
